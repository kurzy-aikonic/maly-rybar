...
**Implementace v repu (kód):**

- Webhook Vercel: `api/revenuecat-webhook.js` + env viz kořen `.env.example`.
- Mobil: `react-native-purchases`, `mobile/src/services/purchasesBridge.ts`, Profil → nákup / restore / refresh.
- Nastavení krok za krokem: `docs/FAZE_6_REVENUECAT.md`.
